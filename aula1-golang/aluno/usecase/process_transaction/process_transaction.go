...
import (
	...
	"github.com/vitorrubio/imersao5/gateway/adapter/broker"
	"github.com/vitorrubio/imersao5/gateway/domain/entity"
	"github.com/vitorrubio/imersao5/gateway/domain/repository"
)
...
func (p *ProcessTransaction) Execute(input TransactionDtoInput) (TransactionDtoOutput, error) {
	...
	fmt.Println("processando:", input.ID)
...
func (p *ProcessTransaction) rejectTransaction(transaction *entity.Transaction, transactionError error) (TransactionDtoOutput, error) {
	...
	output := TransactionDtoOutput{
		ID:           transaction.ID,
		Status:       entity.REJECTED,
		ErrorMessage: transactionError.Error(),
	}
	...
	return output, transactionError
}
